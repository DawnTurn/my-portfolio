...
const projects = () => {
    ...
    return (
        <div className="mt-20 relative z-10 lg:mt-28" id='projects'>
            <div className='absolute w-[2.7em] h-[5em] skew-y-[40deg] bg-secondary dark:bg-gray-200 right-0 top-0 -z-10'></div>
            <div className='z-10'>
