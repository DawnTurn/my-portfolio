    ...
    return (
        <div className="flex flex-col gap-8 mt-20 px-7 relative md:px-10 lg:max-w-screen-xl lg:mx-auto lg:flex-row lg:items-center lg:gap-4 lg:px-7 lg:pt-7 lg:pb-20">
            ...
            <div className='text-center z-10 lg:text-left lg:w-[60%]'>
                <h2 className="text-primary text-xl font-medium md:text-2xl lg:text-3xl">Hello!, I'm-</h2>
                <h1 className="text-[2.5rem] font-medium my-2 md:text-[3rem] lg:text-[4.7rem] lg:font-bold">Timmy Turner.</h1>
                <p className="text-sm leading-6 font-[300] text-white/70 dark:font-medium dark:text-gray-800 z-10 md:w-[75%] md:mx-auto md:text-[.95rem] lg:w-[unset] lg:mx-0 lg:text-xl lg:my-4 lg:pr-4">
                ...
                <p className="my-5 text-sm font-[300] text-white/70 dark:font-medium dark:text-gray-800 md:text-[.95rem] lg:mt-7 lg:mb-12 lg:text-lg"><span className="text-lg">🚀</span> Currently specializing in Next.js</p>
                <div className="my-6 flex gap-4 justify-center md:gap-6 lg:justify-start lg:my-0">
